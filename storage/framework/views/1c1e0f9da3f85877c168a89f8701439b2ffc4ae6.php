...
<h3>Add Banner</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('add_banner')); ?>
            ...
            <div class="row d-flex align-items-stretch">
              ...
              <div class="col-12">
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_post_title" value="<?php echo e(old('banner_title')); ?>" name="banner_title" type="text" class="form-control <?php $__errorArgs = ['banner_title'];
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_post_slug" value="<?php echo e(old('banner_slug')); ?>" name="banner_slug" type="text" class="form-control <?php $__errorArgs = ['banner_slug'];
                                                                                                                                              $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
                                                                                                                                              if ($__bag->has($__errorArgs[0])) :
                                                                                                                                                if (isset($message)) {
                                                                                                                                                  $__messageOriginal = $message;
                ...
                <div class="row">
                  <div class="col-6">
                    ...
                    <div class="form-group _form-group">
                      ...
                      <input value="<?php echo e(old('banner_seq')); ?>" placeholder="0" name="banner_seq" class="form-control <?php $__errorArgs = ['banner_seq'];
                                                                                                                                $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
                                                                                                                                if ($__bag->has($__errorArgs[0])) :
                                                                                                                                  if (isset($message)) {
                                                                                                                                    $__messageOriginal = $message;
                ...
                <div class="form-group _form-group">
                  ...
                  <textarea id="input_post_caption" name="banner_caption" placeholder="Write caption here.." class="form-control <?php $__errorArgs = ['banner_caption'];
                                                                                                                                  ...
                                                                                                                                  unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('banner_caption')); ?></textarea>
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_post_title" value="<?php echo e(old('banner_link')); ?>" name="banner_link" type="text" class="form-control <?php $__errorArgs = ['banner_link'];
                                                                                                                                                $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
                                                                                                                                                if ($__bag->has($__errorArgs[0])) :
                                                                                                                                                  if (isset($message)) {
                                                                                                                                                    $__messageOriginal = $message;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/banner/create.blade.php ENDPATH**/ ?>