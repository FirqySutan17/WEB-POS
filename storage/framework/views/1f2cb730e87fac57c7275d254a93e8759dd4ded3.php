          ...
          <tr>
            ...
            <td style="width: 5%;" class="center-text boxAction fontField">
              <div class="boxInside">
                ...
                <div class="boxDelete">
                  <form role="alert" action="<?php echo e(route('clients.destroy', ['client' => $client])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?>
                    <button role="alert" type="submit" class="btn btn-sm btn-danger">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/clients/index.blade.php ENDPATH**/ ?>