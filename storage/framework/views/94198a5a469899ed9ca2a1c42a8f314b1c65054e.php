                                ...
                                <div class="form-group _form-group">
                                    <div class="avatar-upload">
                                        <div class="avatar-edit">
                                            <input name="image" type="file" value="<?php echo e(old('image', $user->image)); ?>"
                                        ...
                                        <div class="avatar-preview">
                                            <div id="imagePreview"
                                                style="background-image: url('<?php echo e(asset('file_upload/'.$user->image)); ?>');">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_name"
                                                value="<?php echo e(old('employee_id', $user->employee_id)); ?>" name="employee_id"
                                                type="text"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_title" value="<?php echo e(old('name', $user->name)); ?>"
                                                ...
                                                class="form-control" placeholder="<?php echo e(old('name', $user->name)); ?>" />
                                        </div>
                                        <!-- end title -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\koontjie-be\resources\views/admin/profile/edit.blade.php ENDPATH**/ ?>