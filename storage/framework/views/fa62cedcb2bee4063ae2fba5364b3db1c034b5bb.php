  ...
  <div class="row">
    <div class="col-12">
      <form action="<?php echo e(route('client-categories.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="card _card quarterWidth">
            ...
            <div class="row">
              <div class="col-12">
                <div class="float-right mTop">
                  <a class="btn btn-outline-secondary _btn-secondary px-4" href="<?php echo e(route('client-categories.index')); ?>">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user01\Documents\bz-cms\resources\views/admin/client-categories/create.blade.php ENDPATH**/ ?>