...
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('edit_project_category', $projectCategory)); ?>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-12">
      <form action="<?php echo e(route('project-categories.update', ['project_category' => $projectCategory])); ?>" method="POST">
            ...
            <div class="row">
              <div class="col-6">
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_banner_title" value="<?php echo e(old('cat_name', $projectCategory->cat_name)); ?>" name="cat_name" type="text" class="form-control <?php $__errorArgs = ['cat_name'];
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-6">
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_banner_slug" value="<?php echo e(old('cat_slug', $projectCategory->cat_slug)); ?>" name="cat_slug" type="text" class="form-control <?php $__errorArgs = ['cat_slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                ...
                <div class="col-2">
                  <div class="media">
                    <div class="media-body text-end icon-state">
                      <label class="switch">
                        <input type="checkbox" name="is_active" <?php echo e(old('is_active', $projectCategory->is_active) == 1  ? 'checked'  : null); ?>><span class="switch-state"></span>
                      </label>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="row">
                      <div class="col-6">
                        ...
                        <div class="form-group _form-group">
                          ...
                          <input id="input_idname_title" value="<?php echo e(old('id_category_title', $projectCategory->translate('id')->category_title)); ?>" name="id_category_title" type="text" class="form-control <?php $__errorArgs = ['id_category_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="col-6">
                        ...
                        <div class="form-group _form-group">
                          ...
                          <input id="input_idname_slug" value="<?php echo e(old('id_category_slug', $projectCategory->translate('id')->category_slug)); ?>" name="id_category_slug" type="text" class="form-control <?php $__errorArgs = ['id_category_slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="5" placeholder="Write desc here.."><?php echo e(old('id_category_desc', $projectCategory->translate('id')->category_desc)); ?></textarea>
                    ...
                    <div class="row">
                      <div class="col-6">
                        ...
                        <div class="form-group _form-group">
                          ...
                          <input id="input_enname_title" value="<?php echo e(old('en_category_title', $projectCategory->translate('en')->category_title)); ?>" name="en_category_title" type="text" class="form-control <?php $__errorArgs = ['en_category_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="col-6">
                        ...
                        <div class="form-group _form-group">
                          ...
                          <input id="input_enname_slug" value="<?php echo e(old('en_category_slug', $projectCategory->translate('en')->category_slug)); ?>" name="en_category_slug" type="text" class="form-control <?php $__errorArgs = ['en_category_slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="5" placeholder="Write desc here.."><?php echo e(old('en_category_desc', $projectCategory->translate('en')->category_desc)); ?></textarea>
            ...
            <div class="row">
              <div class="col-12">
                <div class="float-right mTop">
                  <a class="btn btn-outline-primary _btn-primary px-4" href="<?php echo e(route('project-categories.index')); ?>">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/project-categories/edit.blade.php ENDPATH**/ ?>