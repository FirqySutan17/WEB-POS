  ...
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      <div class="logo-wrapper"><a href="<?php echo e(route('home')); ?>">
          ...
          <img class="img-fluid" style="width: 120px" src="<?php echo e(asset('images/logo.png')); ?>" alt=""></a>
      </div>
...
</div><?php /**PATH D:\Personal\Github\koontjie-be\resources\views/layouts/admin/partials/header.blade.php ENDPATH**/ ?>