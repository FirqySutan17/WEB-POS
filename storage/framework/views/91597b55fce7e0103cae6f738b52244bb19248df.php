...
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('career_category')); ?>
      ...
      <div class="boxHeader">
        ...
        <form class="row" method="GET">
          ...
          <div class="col-4 pright">
            ...
            <a href="<?php echo e(route('career-categories.create')); ?>" class="btn btn-primary float-right" role="button">
    ...
    <div class="card-body table-responsive">
      <table class="display" id="advance-12">
        ...
        <tbody>
          ...
          <tr>
            <td style="width: 85%;" class="fontField" style="vertical-align: middle;"><?php echo e($category->category_name); ?></td>
            ...
            <td style="width: 5%;" class="center-text boxAction fontField">
              <div class="boxInside">
                ...
                <div class="boxEdit">
                  <a href="<?php echo e(route('career-categories.edit', ['career_category' => $category])); ?>" class="btn btn-sm btn-info" role="button">
                ...
                <div class="boxDelete">
                  <form action="<?php echo e(route('career-categories.destroy', ['career_category' => $category])); ?>" role="alert" method="POST">
                    <?php echo csrf_field(); ?>
          ...
          <p style="text-align: center; padding-top: 50px;">
            <strong> No career category data yet</strong>
          </p>
          <?php endif; ?>
        </tbody>
      </table>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/career-categories/index.blade.php ENDPATH**/ ?>