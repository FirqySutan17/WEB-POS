...
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('banner_category')); ?>
      ...
      <div class="boxHeader">
        ...
        <form class="row" method="GET">
          ...
          <div class="col-4 pright">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Banner Category Create')): ?>
            <a href="<?php echo e(route('banner-categories.create')); ?>" class="btn btn-primary float-right" role="button">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="width: 5%;" class="center-text boxAction fontField">
              <div class="boxInside">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Banner Category Update')): ?>
                <div class="boxEdit">
                  <a href="<?php echo e(route('banner-categories.edit', ['banner_category' => $category])); ?>" class="btn btn-sm btn-info" role="button">
                    <i class="fa fa-edit"></i>
                  </a>
                </div>
                <?php endif; ?>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Banner Category Delete')): ?>
                <div class="boxDelete">
                  <form action="<?php echo e(route('banner-categories.destroy', ['banner_category' => $category])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/banner-categories/index.blade.php ENDPATH**/ ?>