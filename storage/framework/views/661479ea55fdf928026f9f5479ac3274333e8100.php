...
unset($__errorArgs, $__bag); ?>
                ...
                <nav>
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-id-tab" data-bs-toggle="tab" data-bs-target="#nav-id" type="button" role="tab" aria-controls="nav-id" aria-selected="true">ID</button>
                    <button class="nav-link" id="nav-en-tab" data-bs-toggle="tab" data-bs-target="#nav-en" type="button" role="tab" aria-controls="nav-en" aria-selected="false">EN</button>
                  </div>
                </nav>
                    ...
                    <div class="row">
                      <div class="col-12">
                        ...
                        <div class="form-group _form-group">
                          ...
                          <textarea id="input_post_caption" name="id_project_caption" placeholder="Write short description here.." class="form-control <?php $__errorArgs = ['id_project_caption'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                    ...
                    <div class="row">
                      <div class="col-12">
                        ...
                        <div class="form-group _form-group">
                          ...
                          <textarea id="input_post_caption" name="en_project_caption" placeholder="Write short description here.." class="form-control <?php $__errorArgs = ['en_project_caption'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
            ...
            <div class="row">
              <div class="col-12">
                <div class="float-right mTop">
                  <a class="btn btn-outline-secondary _btn-secondary px-4" href="<?php echo e(route('projects.index')); ?>">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user01\Documents\bz-cms\resources\views/admin/project/edit.blade.php ENDPATH**/ ?>