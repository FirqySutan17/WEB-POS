                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="float-right">
                                    <a class="btn btn-outline-secondary _btn-secondary px-4 mx-2" href="<?php echo e(route('roles.index')); ?>">
                                        Back
                                    </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\Check Coding\admin-cms\resources\views/admin/roles/edit.blade.php ENDPATH**/ ?>