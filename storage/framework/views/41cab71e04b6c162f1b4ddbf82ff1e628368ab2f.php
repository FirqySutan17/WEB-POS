...
<h3>Add Event</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('add_event')); ?>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group _form-group">
                                                    ...
                                                    <input id="input_post_title" value="<?php echo e(old('date')); ?>" name="date" type="date" class="form-control <?php $__errorArgs = ['date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u551360984/domains/lifetime-studios.com/public_html/cms-rimba/resources/views/admin/event/create.blade.php ENDPATH**/ ?>