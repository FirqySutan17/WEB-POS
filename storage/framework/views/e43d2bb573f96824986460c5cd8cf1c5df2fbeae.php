...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
   noreplay this message. We just got request to reset password this your token: <?php echo e($token); ?> 
 </div>
 <!-- end preheader -->
                   ...
                   <table border="0" cellpadding="0" cellspacing="0">
                     <tr>
                       <td align="center" bgcolor="#f52738" style="border-radius: 6px;">
                         <a href="<?php echo e(route('reset.password.get', $token)); ?>" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Reset Now</a>
                       </td>
                     </tr>
                   </table>
                 </td>
...
<?php echo $__env->make('admin.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user01\Documents\bz-cms\resources\views/email/forgetPassword.blade.php ENDPATH**/ ?>