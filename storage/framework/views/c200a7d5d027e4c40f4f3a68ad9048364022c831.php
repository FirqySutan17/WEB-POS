        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <!-- Team -->
                    <li>
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('teams.index')); ?>" href="<?php echo e(route('teams.index')); ?>">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['Manage Projects', 'Manage Project Category'])): ?>
                    <li class="dropdown">
                        <a class="nav-link navSubMenu menu-title <?php echo e(routeActive(['careers.index', 'careers.show', 'careers.edit', 'careers.create', 'career-categories.index', 'career-categories.show', 'career-categories.edit', 'career-categories.create'])); ?>" href="javascript:void(0)"><i data-feather="briefcase"></i><span>Careers</span></a>
                        <ul class="nav-submenu menu-content">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Projects')): ?>
                            <li>
                                <a class="<?php echo e(routeActive(['careers.index', 'careers.show', 'careers.edit', 'careers.create'])); ?>" href="<?php echo e(route('careers.index')); ?>">Career</a>
                            </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Project Category')): ?>
                            <li>
                                <a class="<?php echo e(routeActive(['career-categories.index', 'career-categories.show', 'career-categories.edit', 'career-categories.create'])); ?>" href="<?php echo e(route('career-categories.index')); ?>">Categories</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </li>
...
</header><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/layouts/admin/partials/sidebar.blade.php ENDPATH**/ ?>