...
<h3>Edit Post Tag</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('edit_post_tag', $PostTag)); ?>
        ...
        <div class="col-12">
            <div class="card ">
                <div class="card-body -card-body">
                    <form action="<?php echo e(route('post-tags.update', ['post_tag' => $PostTag])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group _form-group">
                                    ...
                                    <input id="input_tag_title" value="<?php echo e(old('tag_title', $PostTag->tag_title)); ?>" name="tag_title" type="text" class="form-control <?php $__errorArgs = ['tag_title'];
                                ...
                                <div class="form-group _form-group">
                                    ...
                                    <input id="input_tag_slug" value="<?php echo e(old('tag_slug', $PostTag->tag_slug)); ?>" name="tag_slug" type="text" class="form-control <?php $__errorArgs = ['tag_slug'];
                                                                                                                                                                                $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
                                                                                                                                                                                if ($__bag->has($__errorArgs[0])) :
                                                                                                                                                                                    if (isset($message)) {
                                                                                                                                                                                        $__messageOriginal = $message;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\Check Coding\admin-cms\resources\views/admin/posts-tags/edit.blade.php ENDPATH**/ ?>