                        ...
                        <div class="row d-flex align-items-stretch">
                            <div class="col-12">
                                ...
                                <div class="form-group _form-group">
                                    ...
                                    <input type="hidden" name="oldImage" value="<?php echo e(old('image')); ?>">
                                    <?php if($user->image): ?>
                                        <img src="<?php echo e(old('image') . env('MEDIA_URL') . $user->image); ?>" class="img-preview d-block img-fluid" alt="<?php echo e($user->image); ?>" style="width: 100px; object-fit: cover; margin: 15px 0; border-radius: 50%">
                                    <?php else: ?>
                                        <img class="img-preview d-block img-fluid" alt="<?php echo e($user->image); ?>" style="width: 100px; object-fit: cover; margin: 15px 0; border-radius: 50%">
                                    <?php endif; ?>
                                    <input type="file"  name="image" require class="form-control <?php $__errorArgs = ['image'];
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user01\Documents\CMS\bz-cms\resources\views/admin/profile/edit.blade.php ENDPATH**/ ?>