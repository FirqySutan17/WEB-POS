...
<h3>Add How We Work</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('add_hww')); ?>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <form action="<?php echo e(route('how-we-work.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\compro.rimba.laravel\resources\views/admin/how-we-work/create.blade.php ENDPATH**/ ?>