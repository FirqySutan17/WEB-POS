...
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('project_category')); ?>
      ...
      <div class="boxHeader">
        ...
        <form class="row" method="GET">
          ...
          <div class="col-4 pright">
            ...
            <a href="<?php echo e(route('project-categories.create')); ?>" class="btn btn-primary float-right _btn" role="button">
      ...
      <table class="display" id="advance-12">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="width: 5%;" class="center-text boxAction fontField">
              <div class="boxInside">
                ...
                <div class="boxEdit">
                  <a href="<?php echo e(route('project-categories.edit', ['project_category' => $category])); ?>" class="btn-sm btn-info" role="button">
                ...
                <div class="boxDelete">
                  <form action="<?php echo e(route('project-categories.destroy', ['project_category' => $category])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
          ...
          <p style="text-align: center; padding-top: 50px;">
            ...
            <?php else: ?>
            <strong> No Project Category data yet</strong>
            <?php endif; ?>
          </p>
          <?php endif; ?>
        </tbody>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/project-categories/index.blade.php ENDPATH**/ ?>