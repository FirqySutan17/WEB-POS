...
<h3>Edit Career</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('add_career', $career)); ?>
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-12">
      ...
      <form action="<?php echo e(route('careers.update', ['career' => $career])); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-6 pr">
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_project_title" value="<?php echo e(old('career_name', $career->career_name)); ?>" name="career_name" type="text" class="form-control <?php $__errorArgs = ['career_name'];
                ...
                <div class="row">
                  <div class="col-6">
                    ...
                    <div class="form-group _form-group">
                      ...
                      <input id="input_project_title" value="<?php echo e(old('career_location', $career->career_location)); ?>" name="career_location" type="text" class="form-control <?php $__errorArgs = ['career_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-6">
                    ...
                    <div class="form-group _form-group">
                      ...
                      <input id="input_project_title" value="<?php echo e(old('career_info', $career->career_info)); ?>" name="career_info" type="text" class="form-control <?php $__errorArgs = ['career_info'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-6">
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_project_slug" value="<?php echo e(old('career_slug', $career->career_slug)); ?>" name="career_slug" type="text" class="form-control <?php $__errorArgs = ['career_slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" for="select_banner_category">Category</label> <span class="wajib">* </span>
                  <select id="select_banner_category" name="category" data-placeholder="Choose Role" class="js-example-placeholder-multiple">
                    ...
                    <option value="<?php echo e(old('category', $categorySelected['id'])); ?>" selected>
                      <?php echo e(old('category', $categorySelected['category_name'])); ?>
                    ...
                    <div class="row">
                      <div class="col-12">
                        ...
                        <div class="form-group _form-group">
                          ...
                          <textarea id="input_post_excerpt" name="id_job_description" placeholder="Write job description here.." class="form-control <?php $__errorArgs = ['id_job_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('id_job_description', $career->translate('id')->job_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group _form-group">
                          ...
                          <textarea id="input_post_description" name="id_job_desk" placeholder="Write job desk here.." class="form-control <?php $__errorArgs = ['id_job_desk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="20"><?php echo e(old('id_job_desk', $career->translate('id')->job_desk)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group _form-group">
                          ...
                          <textarea id="input_post_requirement" name="id_job_requirements" placeholder="Write job description here.." class="form-control <?php $__errorArgs = ['id_job_requirements'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('id_job_requirements', $career->translate('id')->job_requirements)); ?></textarea>
                    ...
                    <div class="row">
                      <div class="col-12">
                        ...
                        <div class="form-group _form-group">
                          ...
                          <textarea id="input_project_excerpt" name="en_job_description" placeholder="Write job description here.." class="form-control <?php $__errorArgs = ['en_job_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('en_job_description', $career->translate('en')->job_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group _form-group">
                          ...
                          <textarea id="input_project_description" name="en_job_desk" placeholder="Write job desk here.." class="form-control <?php $__errorArgs = ['en_job_desk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="20" style="height: 404px;"><?php echo e(old('en_job_desk', $career->translate('en')->job_desk)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group _form-group">
                          ...
                          <textarea id="input_project_requirement" name="en_job_requirements" placeholder="Write job requirement here.." class="form-control <?php $__errorArgs = ['en_job_requirements'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="20" style="height: 404px;"><?php echo e(old('en_job_requirements', $career->translate('en')->job_requirements)); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/careers/edit.blade.php ENDPATH**/ ?>