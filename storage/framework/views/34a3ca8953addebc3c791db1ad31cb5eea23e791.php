      ...
      <div class="boxHeader">
        ...
        <form class="row" method="GET">
          ...
          <div class="col-4 pright">
            ...
            <a href="<?php echo e(route('client-categories.create')); ?>" class="btn btn-primary float-right" role="button">
          ...
          <tr>
            ...
            <td style="width: 5%;" class="center-text boxAction fontField">
              <div class="boxInside">
                ...
                <div class="boxEdit">
                  <a href="<?php echo e(route('client-categories.edit', ['client_category' => $category])); ?>" class="btn btn-sm btn-info" role="button">
                ...
                <div class="boxDelete">
                  <form action="<?php echo e(route('client-categories.destroy', ['client_category' => $category])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user01\Documents\bz-cms\resources\views/admin/client-categories/index.blade.php ENDPATH**/ ?>