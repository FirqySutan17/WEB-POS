...
<h3>Add Location</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('add_location')); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="float-right">
                                    <a class="btn btn-outline-primary _btn-primary px-4" href="<?php echo e(route('location.index')); ?>">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u551360984/domains/lifetime-studios.com/public_html/cms-rimba/resources/views/admin/locations/create.blade.php ENDPATH**/ ?>