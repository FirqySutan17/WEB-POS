...
<h3>Edit Gallery</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('edit_gallery', $gallery)); ?>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<form action="<?php echo e(route('gallery.update', ['gallery' => $gallery])); ?>" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input  id="datepicker" value="<?php echo e(old('year', $gallery->year)); ?>" name="year" type="text" class="form-control <?php $__errorArgs = ['year'];
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="input_post_thumbnail" name="image" value="<?php echo e(old('image', $gallery->image)); ?>" type="text" class="form-control <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_alt" value="<?php echo e(old('alt_text', $gallery->alt_text)); ?>" name="alt_text" type="text" class="form-control <?php $__errorArgs = ['alt_text'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="20"><?php echo e(old('description', $gallery->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group <?php echo e($errors->has('is_active') ? ' has-error' : ''); ?> _form-group" style="display: flex;">
                                    ...
                                    <div class="media">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="is_active" <?php echo e(old("is_active", $gallery->is_active) == 1  ? "checked"  : null); ?>><span class="switch-state"></span>
                                        </label>
                                        </div>
                                    </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="float-right">
                                    <a class="btn btn-outline-primary _btn-primary px-4" href="<?php echo e(route('gallery.index')); ?>">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\compro.rimba.laravel\resources\views/admin/gallery/edit.blade.php ENDPATH**/ ?>