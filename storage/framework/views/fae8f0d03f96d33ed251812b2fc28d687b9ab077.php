...
<h3>Add Partner</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('add_partner')); ?>
    ...
    <div class="row">
        <div class="col-12">
            <form action="<?php echo e(route('partner.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card _card" style="width: 60%; margin: auto; padding-bottom: 0px">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\compro.rimba.laravel\resources\views/admin/partner/create.blade.php ENDPATH**/ ?>