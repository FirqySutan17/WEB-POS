...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<form action="<?php echo e(route('partner.update', ['partner' => $partner])); ?>" method="POST" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input name="image" type="file" value="<?php echo e(old('image', $partner->image)); ?>" class="form-control" />
                                            <?php if (!empty($partner->image)): ?>
                                                <br>
                                                <a href="<?php echo e(asset('file_upload/'.$partner->image)); ?>" target="_blank" class="btn btn-primary">Lihat File</a>
                                            <?php endif ?>
                                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u551360984/domains/lifetime-studios.com/public_html/cms-rimba/resources/views/admin/partner/edit.blade.php ENDPATH**/ ?>