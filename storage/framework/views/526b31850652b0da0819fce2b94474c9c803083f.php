...
<h3>Edit Project</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('edit_project', $project)); ?>
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-12">
      ...
      <form action="<?php echo e(route('projects.update', ['project' => $project])); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-6 pr">
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_project_title" value="<?php echo e(old('project_name', $project->project_name)); ?>" name="project_name" type="text" class="form-control <?php $__errorArgs = ['project_name'];
                ...
                <div class="row">
                  <div class="col-2">
                    ...
                    <div class="form-group _form-group">
                      ...
                      <input value="<?php echo e(old('project_seq', $project->project_seq)); ?>" placeholder="0" name="project_seq" class="form-control <?php $__errorArgs = ['project_seq'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-10">
                    ...
                    <div class="form-group _form-group">
                      ...
                      <input type="file" value="<?php echo e(old('project_thumbnail', $project->project_thumbnail)); ?>" name="project_thumbnail" require class="form-control <?php $__errorArgs = ['project_thumbnail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-6">
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_project_slug" value="<?php echo e(old('project_slug', $project->project_slug)); ?>" name="project_slug" type="text" class="form-control <?php $__errorArgs = ['project_slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group _form-group">
                  ...
                  <input type="file" value="<?php echo e(old('project_cover', $project->project_cover)); ?>" name="project_cover" require class="form-control <?php $__errorArgs = ['project_cover'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-group">
                ...
                <select id="select_project_category" name="category[]" data-placeholder="" class="custom-select" multiple>
                  <?php if(old('category', $project->categories)): ?>
                  <?php $__currentLoopData = old('category', $project->categories); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <div class="form-group _form-group">
                    ...
                    <input id="input_project_title" value="<?php echo e(old('project_gd', $project->project_gd)); ?>" name="project_gd" type="text" class="form-control <?php $__errorArgs = ['project_gd'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-6">
                  ...
                  <div class="form-group _form-group">
                    ...
                    <input id="input_project_title" value="<?php echo e(old('project_cs', $project->project_cs)); ?>" name="project_cs" type="text" class="form-control <?php $__errorArgs = ['project_cs'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <div class="form-group _form-group">
                    ...
                    <input id="input_project_title" value="<?php echo e(old('project_photographer', $project->project_photographer)); ?>" name="project_photographer" type="text" class="form-control <?php $__errorArgs = ['project_photographer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-6">
                  ...
                  <div class="form-group _form-group">
                    ...
                    <input id="input_project_title" value="<?php echo e(old('project_pm', $project->project_pm)); ?>" name="project_pm" type="text" class="form-control <?php $__errorArgs = ['project_pm'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <div class="form-group _form-group">
                    ...
                    <input id="input_project_title" value="<?php echo e(old('project_wd', $project->project_wd)); ?>" name="project_wd" type="text" class="form-control <?php $__errorArgs = ['project_wd'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                ...
                <div class="col-2">
                  <div class="media">
                    <div class="media-body text-end icon-state">
                      <label class="switch">
                        <input type="checkbox" name="is_active" <?php echo e(old("is_active", $project->is_active) == 1  ? "checked"  : null); ?>><span class="switch-state"></span>
                      </label>
                    </div>
                  </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('id_project_caption', $project->translate('id')->project_caption)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="20"><?php echo e(old('id_project_description', $project->translate('id')->project_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('en_project_caption', $project->translate('en')->project_caption)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="20" style="height: 404px;"><?php echo e(old('en_project_description', $project->translate('en')->project_caption)); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/project/edit.blade.php ENDPATH**/ ?>