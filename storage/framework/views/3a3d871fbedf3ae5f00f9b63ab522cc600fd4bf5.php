					...
					<tr>
						...
						<td style="width: 5%;" class="center-text boxAction fontField">
							<div class="boxInside">
								...
								<div class="boxEdit">
									<a href="<?php echo e(route('users.edit', ['user' => $user])); ?>" class="btn btn-sm btn-info" role="button">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\Check Coding\admin-cms\resources\views/admin/users/index.blade.php ENDPATH**/ ?>