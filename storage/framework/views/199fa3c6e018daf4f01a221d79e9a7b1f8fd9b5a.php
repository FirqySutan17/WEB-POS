...
<h3>Edit Banner Category</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('edit_banner_category', $bannerCategory)); ?>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-12">
      <form action="<?php echo e(route('banner-categories.update', ['banner_category' => $bannerCategory])); ?>" method="POST">
            ...
            <div class="row d-flex align-items-stretch">
              <div class="col-12">
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_banner_title" value="<?php echo e(old('category_title', $bannerCategory->category_title)); ?>" name="category_title" type="text" class="form-control <?php $__errorArgs = ['category_title'];
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_banner_slug" name="category_slug" type="text" class="form-control <?php $__errorArgs = ['category_slug'];
                                                                                                      ...
                                                                                                      unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('category_slug', $bannerCategory->category_slug)); ?>" readonly />
                ...
                <div class="form-group _form-group">
                  ...
                  <textarea id="input_category_caption" value="" name="category_desc" placeholder="" class="form-control <?php $__errorArgs = ['category_desc'];
                                                                                                                          ...
                                                                                                                          unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('category_desc', $bannerCategory->category_desc)); ?></textarea>
                  ...
                  <div class="col-2">
                    <div class="media">
                      <div class="media-body text-end icon-state">
                        <label class="switch">
                          <input type="checkbox" name="is_active" <?php echo e(old('is_active', $bannerCategory->is_active) == 1  ? 'checked'  : null); ?>><span class="switch-state"></span>
                        </label>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="float-right mTop">
                  <a class="btn btn-outline-secondary _btn-secondary px-4" href="<?php echo e(route('banner-categories.index')); ?>">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\Check Coding\admin-cms\resources\views/admin/banner-categories/edit.blade.php ENDPATH**/ ?>