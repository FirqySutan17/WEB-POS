...
<h3>Banner</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('banner')); ?>
			...
			<div class="boxHeader">
				...
				<form class="row" method="GET">
                    <div class="col-8">
                        ...
                        <a href="<?php echo e(route('banner.create')); ?>" class="btn btn-primary _btn" role="button">
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
                        ...
                        <td style="width: 80%;" class="center-text"><?php echo e($banner->title); ?></td>
						<td style="width: 15%;" class="center-text boxAction fontField">
							<div class="boxInside">
								<div class="boxEdit">
									<a href="<?php echo e(route('banner.edit', ['banner' => $banner])); ?>" class="btn-sm btn-info" role="button">
								...
								<div class="boxDelete">
									<form action="<?php echo e(route('banner.destroy', ['banner' => $banner])); ?>" method="POST">
										<?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\laravel-cms\resources\views/admin/banner/index.blade.php ENDPATH**/ ?>