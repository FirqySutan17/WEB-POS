...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<form action="<?php echo e(route('portfolio.update', ['portfolio' => $portfolio])); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_title" value="<?php echo e(old('name', $portfolio->name)); ?>" name="name" type="text" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <select id="select_user_type" name="product_type" data-placeholder="Choose product type" class="js-example-placeholder-multiple">
                                                <option value="0" <?php echo e($portfolio->product_type == '0' ? 'selected':''); ?>>Choose product type</option>
                                                <option value="Tree" <?php echo e($portfolio->product_type == 'Tree' ? 'selected':''); ?>>Tree</option>
                                                <option value="River" <?php echo e($portfolio->product_type == 'River' ? 'selected':''); ?>>River</option>
                                                <option value="Rock" <?php echo e($portfolio->product_type == 'Rock' ? 'selected':''); ?>>Rock</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            <label for="input_post_description" class="font-weight-bold">
                                                Logo <span class="wajib">* </span>
                                            </label>
                                            <input name="logo" type="file" value="<?php echo e(old('logo', $portfolio->logo)); ?>" class="form-control" />
                                            <?php if (!empty($portfolio->logo)): ?>
                                                <br>
                                                <a href="<?php echo e(asset('file_upload/'.$portfolio->logo)); ?>" target="_blank" class="btn btn-primary">Lihat File</a>
                                            <?php endif ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input name="image_cover" type="file" value="<?php echo e(old('image_cover', $portfolio->image_cover)); ?>" class="form-control" />
                                            <?php if (!empty($portfolio->image_cover)): ?>
                                                <br>
                                                <a href="<?php echo e(asset('file_upload/'.$portfolio->image_cover)); ?>" target="_blank" class="btn btn-primary">Lihat File</a>
                                            <?php endif ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_slug" value="<?php echo e(old('slug', $portfolio->slug)); ?>" name="slug" type="text" class="form-control <?php $__errorArgs = ['slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group  _form-group">
                                            ...
                                            <select id="select_user_role" name="project_type_id" data-placeholder="Choose project type" class="custom-select <?php $__errorArgs = ['project_type_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                <?php if(old('project_type_id', $projectSelected)): ?>
                                                <option value="<?php echo e(old('project_type_id', $projectSelected)->id); ?>" selected>
                                                    <?php echo e(old('project_type_id', $projectSelected)->name); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            <label for="input_user_alt" class="font-weight-bold">
                                                Alt Text Logo <span class="wajib">*</span>
                                            </label>
                                            <input id="input_user_alt" value="<?php echo e(old('alt_text_logo', $portfolio->alt_text_logo)); ?>" name="alt_text_logo" type="text" class="form-control <?php $__errorArgs = ['alt_text_logo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            <label for="input_user_alt" class="font-weight-bold">
                                                Alt Text Cover <span class="wajib">*</span>
                                            </label>
                                            <input id="input_user_alt" value="<?php echo e(old('alt_text_cover', $portfolio->alt_text_cover)); ?>" name="alt_text_cover" type="text" class="form-control <?php $__errorArgs = ['alt_text_cover'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group  _form-group">
                                    ...
                                    <select id="select_portfolio_skill" name="skill[]" data-placeholder="Choose tech stack" class="custom-select" multiple>
                                ...
                                <div class="form-group _form-group">
                                    <label for="input_post_company" class="font-weight-bold">
                                        Company <span class="wajib">* </span>
                                    </label>
                                    <input id="input_post_company" value="<?php echo e(old('company', $portfolio->company)); ?>" name="company" type="text" class="form-control <?php $__errorArgs = ['company'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Input company here" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group _form-group">
                                    ...
                                    <input id="input_post_link" value="<?php echo e(old('link', $portfolio->link)); ?>" name="link" type="text" class="form-control <?php $__errorArgs = ['link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Input link here" />
...
unset($__errorArgs, $__bag); ?>" rows="7"><?php echo e(old('description', $portfolio->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group <?php echo e($errors->has('is_active') ? ' has-error' : ''); ?> _form-group" style="display: flex; margin-top: 30px">
                                    ...
                                    <div class="media">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="is_active" <?php echo e(old("is_active", $portfolio->is_active) == 1  ? "checked"  : null); ?>><span class="switch-state"></span>
                                        </label>
                                        </div>
                                    </div>
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u551360984/domains/lifetime-studios.com/public_html/cms-rimba/resources/views/admin/portfolio/edit.blade.php ENDPATH**/ ?>