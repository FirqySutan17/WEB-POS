...
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('add_project_category')); ?>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-12">
      ...
      <form action="<?php echo e(route('project-categories.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/project-categories/create.blade.php ENDPATH**/ ?>