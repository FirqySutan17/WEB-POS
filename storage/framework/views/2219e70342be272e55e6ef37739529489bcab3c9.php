<div class="page-main-header">
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      <div class="logo-wrapper"><a href="<?php echo e(route('index')); ?>">
          <h5 style="margin-top:10px;"><strong>Admin CMS</strong> </h5>
          <!-- <img class="img-fluid" src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt=""></a> -->
      </div>
      ...
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown p-0">
          <button class="btn btn-primary-light" type="button">
            <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i data-feather="log-out"></i><?php echo e(__('Logout')); ?></a>
          </button>
...
</div><?php /**PATH C:\Brandztory Projects\Check Coding\admin-cms\resources\views/layouts/admin/partials/header.blade.php ENDPATH**/ ?>