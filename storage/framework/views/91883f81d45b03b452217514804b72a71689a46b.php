			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td style="width: 30%;" class="center-text"><?php echo $p->description; ?></td>
						...
						<td style="width: 10%;" class="center-text boxAction fontField">
							<div class="boxInside">
								...
								<div class="boxDelete">
									<form action="<?php echo e(route('product.destroy', ['product' => $p])); ?>" method="POST">
										<?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\compro.rimba.laravel\resources\views/admin/product/index.blade.php ENDPATH**/ ?>