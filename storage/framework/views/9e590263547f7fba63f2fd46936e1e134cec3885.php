                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_title" value="<?php echo e(old('name', $meta->name)); ?>"
                                                name="name" type="text"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mtitle"
                                                value="<?php echo e(old('meta_title', $meta->meta_title)); ?>" name="meta_title"
                                                type="text"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mdescription"
                                                value="<?php echo e(old('meta_description', $meta->meta_description)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mtitle" value="<?php echo e(old('og_title', $meta->og_title)); ?>"
                                                name="og_title" type="text"
                                                class="form-control <?php $__errorArgs = ['og_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_murl" value="<?php echo e(old('og_url', $meta->og_url)); ?>"
                                                name="og_url" type="text"
                                                class="form-control <?php $__errorArgs = ['og_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mimage_width"
                                                value="<?php echo e(old('og_image_width', $meta->og_image_width)); ?>"
                                                name="og_image_width" type="text"
                                                class="form-control <?php $__errorArgs = ['og_image_width'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mtype" value="<?php echo e(old('og_type', $meta->og_type)); ?>"
                                                name="og_type" type="text"
                                                class="form-control <?php $__errorArgs = ['og_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mdescription"
                                                value="<?php echo e(old('og_description', $meta->og_description)); ?>"
                                                name="og_description" type="text"
                                                class="form-control <?php $__errorArgs = ['og_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_tcard"
                                                value="<?php echo e(old('twitter_card', $meta->twitter_card)); ?>"
                                                name="twitter_card" type="text"
                                                class="form-control <?php $__errorArgs = ['twitter_card'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_tdescription"
                                                value="<?php echo e(old('twitter_description', $meta->twitter_description)); ?>"
                                                name="twitter_description" type="text"
                                                class="form-control <?php $__errorArgs = ['twitter_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_tcreator"
                                                value="<?php echo e(old('twitter_creator', $meta->twitter_creator)); ?>"
                                                name="twitter_creator" type="text"
                                                class="form-control <?php $__errorArgs = ['twitter_creator'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_slug" value="<?php echo e(old('slug', $meta->slug)); ?>"
                                                name="slug" type="text"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mkeyword"
                                                value="<?php echo e(old('meta_keyword', $meta->meta_keyword)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mrobots"
                                                value="<?php echo e(old('meta_robots', $meta->meta_robots)); ?>" name="meta_robots"
                                                type="text"
                                                class="form-control <?php $__errorArgs = ['meta_robots'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_msite_name"
                                                value="<?php echo e(old('og_site_name', $meta->og_site_name)); ?>"
                                                name="og_site_name" type="text"
                                                class="form-control <?php $__errorArgs = ['og_site_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mimage_height"
                                                value="<?php echo e(old('og_image_height', $meta->og_image_height)); ?>"
                                                name="og_image_height" type="text"
                                                class="form-control <?php $__errorArgs = ['og_image_height'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mlocale"
                                                value="<?php echo e(old('og_locale', $meta->og_locale)); ?>" name="og_locale"
                                                type="text"
                                                class="form-control <?php $__errorArgs = ['og_locale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_malternate"
                                                value="<?php echo e(old('og_alternate', $meta->og_alternate)); ?>"
                                                name="og_alternate" type="text"
                                                class="form-control <?php $__errorArgs = ['og_alternate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_ttitle"
                                                value="<?php echo e(old('twitter_title', $meta->twitter_title)); ?>"
                                                name="twitter_title" type="text"
                                                class="form-control <?php $__errorArgs = ['twitter_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_tsite"
                                                value="<?php echo e(old('twitter_site', $meta->twitter_site)); ?>"
                                                name="twitter_site" type="text"
                                                class="form-control <?php $__errorArgs = ['twitter_site'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <br>
                                            <a href="<?php echo e(asset('file_upload/'.$meta->twitter_image)); ?>" target="_blank"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <br>
                                            <a href="<?php echo e(asset('file_upload/'.$meta->og_image)); ?>" target="_blank"
                                                class="btn btn-primary">Lihat File</a>
                                            <?php endif ?>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group _form-group" style="display: none">
                                    ...
                                    <textarea id="input_post_schema_markup" name="schema_markup"
                                        ...
                                        class="form-control <?php $__errorArgs = ['schema_markup'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        rows="7"><?php echo e(old('schema_markup', $meta->schema_markup)); ?></textarea>
                            ...
                            <div class="col-12">
                                <div class="float-right">
                                    <a class="btn btn-outline-primary _btn-primary px-4"
                                        href="<?php echo e(route('metas.index')); ?>">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\koontjie-be\resources\views/admin/meta/edit.blade.php ENDPATH**/ ?>