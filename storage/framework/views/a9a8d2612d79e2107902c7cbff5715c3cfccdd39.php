			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td style="width: 20%;" class="center-text"><?php echo Str::limit($t->description, 30); ?></td>
						<td style="width: 15%;" class="center-text">
                            <a data-fancybox="gallery" class="primary-btn" href="<?php echo e(asset('file_upload/'.$t->image)); ?>" style="color: #063DFF;">Open Image</a>
                        </td>
						<td style="width: 10%;" class="center-text boxAction fontField">
							<div class="boxInside">
								...
								<div class="boxDelete">
									<form role="alert" action="<?php echo e(route('team.destroy', ['team' => $t])); ?>" method="POST">
										<?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u551360984/domains/lifetime-studios.com/public_html/cms-rimba/resources/views/admin/team/index.blade.php ENDPATH**/ ?>