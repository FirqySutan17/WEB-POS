            ...
            <div class="row d-flex align-items-stretch">
              ...
              <div class="col-12">
                    ...
                    <div class="form-group _form-group">
                      ...
                      <select id="select_post_tag" name="category[]" data-placeholder="" class="custom-select" multiple>
                        <?php if (old('category', $client->categories)) : ?>
                          <?php $__currentLoopData = old('category', $client->categories);
                ...
                <div class="form-group _form-group">
                  ...
                  <input type="file" value="<?php echo e(old('client_image', $client->client_image)); ?>" name="client_image" require class="form-control <?php $__errorArgs = ['client_image'];
                                                                                                                                                          $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
                                                                                                                                                          if ($__bag->has($__errorArgs[0])) :
                                                                                                                                                            if (isset($message)) {
                                                                                                                                                              $__messageOriginal = $message;
            ...
            <div class="row">
              <div class="col-12">
                <div class="float-right mTop">
                  <a class="btn btn-outline-secondary _btn-secondary px-4" href="<?php echo e(route('clients.index')); ?>">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user01\Documents\bz-cms\resources\views/admin/clients/edit.blade.php ENDPATH**/ ?>