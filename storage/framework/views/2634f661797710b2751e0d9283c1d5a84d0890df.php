...
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('detail_project_type', $projectType)); ?>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<form action="<?php echo e(route('project-type.update', ['project_type' => $projectType])); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_title" value="<?php echo e(old('name', $projectType->name)); ?>" name="name" type="text" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_slug" value="<?php echo e(old('slug', $projectType->slug)); ?>" name="slug" type="text" class="form-control <?php $__errorArgs = ['slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group <?php echo e($errors->has('is_active') ? ' has-error' : ''); ?> _form-group" style="display: flex;">
                                    ...
                                    <div class="media">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="is_active" <?php echo e(old("is_active", $projectType->is_active) == 1  ? "checked"  : null); ?>><span class="switch-state"></span>
                                        </label>
                                        </div>
                                    </div>
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\laravel-cms\resources\views/admin/project-type/edit.blade.php ENDPATH**/ ?>