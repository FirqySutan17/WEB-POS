				...
				<tbody>
					...
					<tr>
						...
						<td style="width: 20%;" class="center-text">
                            <a data-fancybox="gallery" class="primary-btn" href="<?php echo e(env('MEDIA_URL') . $ts->image); ?>" style="color: #063DFF;">Open Image</a>
                        </td>
						<td style="width: 10%;" class="center-text boxAction fontField">
							<div class="boxInside">
								...
								<div class="boxDelete">
									<form action="<?php echo e(route('tech-stack.destroy', ['tech_stack' => $ts])); ?>" method="POST">
										<?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\compro.rimba.laravel\resources\views/admin/tech-stack/index.blade.php ENDPATH**/ ?>