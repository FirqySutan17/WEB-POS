...
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('edit_career_category', $careerCategory)); ?>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-12">
      <form action="<?php echo e(route('career-categories.update', ['career_category' => $careerCategory])); ?>" method="POST">
            ...
            <div class="row d-flex align-items-stretch">
              <div class="col-12">
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_banner_title" value="<?php echo e(old('category_name', $careerCategory->category_name)); ?>" name="category_name" type="text" class="form-control <?php $__errorArgs = ['category_name'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('category_slug', $careerCategory->category_slug)); ?>" readonly />
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group _form-group">
                  ...
                  <input id="input_category_caption" value="<?php echo e(old('category_seq', $careerCategory->category_seq)); ?>" name="category_seq" placeholder="" class="form-control <?php $__errorArgs = ['category_seq'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                  ...
                  <div class="col-2">
                    <div class="media">
                      <div class="media-body text-end icon-state">
                        <label class="switch">
                          <input type="checkbox" name="is_active" <?php echo e(old('is_active', $careerCategory->is_active) == 1  ? 'checked'  : null); ?>><span class="switch-state"></span>
                        </label>
                      </div>
                    </div>
                  </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/career-categories/edit.blade.php ENDPATH**/ ?>