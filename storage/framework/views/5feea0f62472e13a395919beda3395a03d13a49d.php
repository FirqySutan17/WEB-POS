...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<form action="<?php echo e(route('how-we-work.update', ['how_we_work' => $howWeWork])); ?>" method="POST" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input name="image" type="file" value="<?php echo e(old('image', $howWeWork->image)); ?>" class="form-control" />
                                            <?php if (!empty($howWeWork->image)): ?>
                                                <br>
                                                <a href="<?php echo e(asset('file_upload/'.$howWeWork->image)); ?>" target="_blank" class="btn btn-primary">Lihat File</a>
                                            <?php endif ?>
                                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u551360984/domains/lifetime-studios.com/public_html/cms-rimba/resources/views/admin/how-we-work/edit.blade.php ENDPATH**/ ?>