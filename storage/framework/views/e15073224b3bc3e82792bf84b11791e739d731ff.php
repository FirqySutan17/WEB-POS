...
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('add_skill')); ?>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_title" value="<?php echo e(old('name')); ?>" name="name"
                            ...
                            <div class="col-12">
                                <div class="float-right">
                                    <a class="btn btn-outline-primary _btn-primary px-4"
                                        href="<?php echo e(route('skill.index')); ?>">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\koontjie-be\resources\views/admin/skills/create.blade.php ENDPATH**/ ?>