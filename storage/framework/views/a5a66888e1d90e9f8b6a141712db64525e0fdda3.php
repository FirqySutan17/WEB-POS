...
<h3>Social</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('social')); ?>
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-12">
      ...
      <form action="<?php echo e(route('social.update', 1)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-12">
                <div class="float-right mTop">
                  <a class="btn btn-outline-primary _btn-primary px-4" href="<?php echo e(route('social.index')); ?>">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Brandztory Projects\brandztory-website\bz-cms\resources\views/admin/website/social/edit.blade.php ENDPATH**/ ?>