...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <select id="select_user_location" name="location" data-placeholder="Choose location" class="js-example-placeholder-multiple">
                                                <option value="0" <?php echo e($career->location == '0' ? 'selected':''); ?>>Choose location</option>
                                                <option value="Jakarta, Indonesia" <?php echo e($career->location == 'Jakarta, Indonesia' ? 'selected':''); ?>>Jakarta, Indonesia</option>
                                                <option value="Tangerang, Indonesia" <?php echo e($career->location == 'Tangerang, Indonesia' ? 'selected':''); ?>>Tangerang, Indonesia</option>
                                                <option value="Bandung, Indonesia" <?php echo e($career->location == 'Bandung, Indonesia' ? 'selected':''); ?>>Bandung, Indonesia</option>
                                            </select>
                                            <?php $__errorArgs = ['role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\laravel-cms\resources\views/admin/career/edit.blade.php ENDPATH**/ ?>