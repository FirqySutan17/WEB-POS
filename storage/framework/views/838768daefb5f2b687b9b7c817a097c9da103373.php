                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_title" value="<?php echo e(old('client_name')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_slug" value="<?php echo e(old('slug')); ?>" name="slug"
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="datepicker" value="<?php echo e(old('start_year')); ?>" name="start_year"
                                                type="text"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-3">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="datepickerend" value="<?php echo e(old('end_year')); ?>" name="end_year"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group _form-group">
                                    ...
                                    <input id="input_post_company" value="<?php echo e(old('project_title')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group _form-group">
                                    ...
                                    <input id="input_post_link" value="<?php echo e(old('link')); ?>" name="link" type="text"
...
unset($__errorArgs, $__bag); ?>"
                                        rows="7"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                        rows="7"><?php echo e(old('description_2')); ?></textarea>
                                    ...
                                    <div class="col-2">
                                        <div class="media">
                                            <div class="media-body text-end icon-state">
                                                <label class="switch">
                                                    <input type="checkbox" name="is_active" <?php echo e(old("is_active")==1
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\koontjie-be\resources\views/admin/portfolio/create.blade.php ENDPATH**/ ?>