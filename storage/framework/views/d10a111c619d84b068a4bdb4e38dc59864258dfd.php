...
<h3>Edit Product</h3>
<?php $__env->endSlot(); ?>
<?php echo e(Breadcrumbs::render('edit_product', $product)); ?>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<form action="<?php echo e(route('product.update', ['product' => $product])); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_title" value="<?php echo e(old('name', $product->name)); ?>" name="name" type="text" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input name="image" type="file" value="<?php echo e(old('image', $product->image)); ?>" class="form-control" />
                                            <?php if (!empty($product->image)): ?>
                                                <br>
                                                <a href="<?php echo e(asset('file_upload/'.$product->image)); ?>" target="_blank" class="btn btn-primary">Lihat File</a>
                                            <?php endif ?>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_slug" value="<?php echo e(old('slug', $product->slug)); ?>" name="slug" type="text" class="form-control <?php $__errorArgs = ['slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_alt" value="<?php echo e(old('alt_text', $product->alt_text)); ?>" name="alt_text" type="text" class="form-control <?php $__errorArgs = ['alt_text'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group _form-group">
                                    <label for="input_post_link" class="font-weight-bold">
                                        Link <span class="wajib">* </span>
                                    </label>
                                    <input id="input_post_link" value="<?php echo e(old('link', $product->link)); ?>" name="link" type="text" class="form-control <?php $__errorArgs = ['link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="20"><?php echo e(old('description', $product->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group <?php echo e($errors->has('label') ? ' has-error' : ''); ?> _form-group" style="display: flex;">
                                    ...
                                    <div class="media">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="label" <?php echo e(old("label", $product->label) == 1  ? "checked"  : null); ?>><span class="switch-state"></span>
                                        </label>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <div class="wrap-btn" style="display: flex">
                                                ...
                                                <input type="color" id="cardcolorpicker" name="card_color" value="<?php echo e(old('card_color', $product->card_color)); ?>" name="card_color" class="<?php $__errorArgs = ['card_color'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <div class="wrap-btn" style="display: flex">
                                                ...
                                                <input type="color" id="colorpicker" name="button_color" value="<?php echo e(old('button_color', $product->button_color)); ?>" name="button_color" class="<?php $__errorArgs = ['button_color'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group <?php echo e($errors->has('is_active') ? ' has-error' : ''); ?> _form-group" style="display: flex;">
                                    ...
                                    <div class="media">
                                        <div class="media-body text-end icon-state">
                                        <label class="switch">
                                            <input type="checkbox" name="is_active" <?php echo e(old("is_active", $product->is_active) == 1  ? "checked"  : null); ?>><span class="switch-state"></span>
                                        </label>
                                        </div>
                                    </div>
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u551360984/domains/lifetime-studios.com/public_html/cms-rimba/resources/views/admin/product/edit.blade.php ENDPATH**/ ?>