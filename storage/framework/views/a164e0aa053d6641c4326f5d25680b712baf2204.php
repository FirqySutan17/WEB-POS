        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Project Type')): ?>
                    <li>
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive(['location.index', 'location.show', 'location.edit', 'location.create'])); ?>" href="<?php echo e(route('location.index')); ?>">
                            <i data-feather="circle"></i>
                            <span>Location</span>
                        </a>
                    </li>
...
</header><?php /**PATH /home/u551360984/domains/lifetime-studios.com/public_html/cms-rimba/resources/views/layouts/admin/partials/sidebar.blade.php ENDPATH**/ ?>