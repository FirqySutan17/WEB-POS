						...
						<div class="row d-flex align-items-stretch">
							...
							<div class="col-12">
								 ...
								 <div class="form-group _form-group">
                                    ...
                                    <div class="pro-up">
                                        <div class="circle">
                                          <img class="profile-pic" src="<?php echo e(env('MEDIA_URL') . $user->image); ?>">
                                        </div>
                                        <div class="p-image">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <select id="select_user_office" name="office" data-placeholder="Choose Office" class="js-example-placeholder-multiple" aria-readonly="true">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Personal\Github\compro.rimba.laravel\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>