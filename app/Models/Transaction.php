...
class Transaction extends Model
{
    ...
    use SoftDeletes;
    protected $fillable = ['membership_id', 'invoice_no', 'receipt_no', 'emp_no', 'trans_date', 'payment_method', 'cash', 'sub_price', 'vat_ppn', 'total_price', 'status', 'cancellation_reason', 'kembalian', 'is_isales'];
