...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <form action="{{ route('common-code.update', ['common_code' => $commonCode]) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group _form-group">
                                            ...
                                            <select id="select_code" name="head_id" data-placeholder="Choose head"
                                                ...
                                                <option value="{{ old('head_id', $codeSelected->id) }}" selected>
                                                    {{old('head_id',$codeSelected->head)}} -
                                                    {{old('head_id',$codeSelected->code_name) }}
                                                </option>
                                            </select>
                                            @error('head')
                                    ...
                                    <div class="col-12">
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_code" value="{{ old('code', $commonCode->code) }}"
                                                name="code" type="text"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_name" value="{{ old('name', $commonCode->name) }}"
                                                name="name" type="text"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group _form-group">
                                            ...
                                            <textarea id="input_desc" value="" name="description" type="text"
                                                ...
                                                placeholder="Type here.."
                                                rows="5">{{ old('description', $commonCode->description) }}</textarea>
                                            @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                                    ...
                                                    <div class="media-body text-end icon-state">
                                                        <label class="switch">
                                                            <input type="checkbox" name="is_active" {{ old("is_active",
                                                                $commonCode->is_active)==1 ? "checked" : null }}><span
