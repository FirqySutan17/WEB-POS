                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mtitle" value="{{ old('meta_title') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mdescription" value="{{ old('meta_description') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mtitle" value="{{ old('og_title') }}" name="og_title"
                                                type="text" class="form-control @error('og_title') is-invalid @enderror"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_murl" value="{{ old('og_url') }}" name="og_url"
                                                type="text" class="form-control @error('og_url') is-invalid @enderror"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mimage_width" value="{{ old('og_image_width') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mtype" value="{{ old('og_type') }}" name="og_type"
                                                type="text" class="form-control @error('og_type') is-invalid @enderror"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mdescription" value="{{ old('og_description') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_tcard" value="{{ old('twitter_card') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_tdescription" value="{{ old('twitter_description') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_tcreator" value="{{ old('twitter_creator') }}"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mkeyword" value="{{ old('meta_keyword') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mrobots" value="{{ old('meta_robots') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_msite_name" value="{{ old('og_site_name') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mimage_height" value="{{ old('og_image_height') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_mlocale" value="{{ old('og_locale') }}"
                                                name="og_locale" type="text"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_malternate" value="{{ old('og_alternate') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_ttitle" value="{{ old('twitter_title') }}"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input name="twitter_image" type="file"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_user_tsite" value="{{ old('twitter_site') }}"
                                ...
                                <div class="form-group _form-group" style="display: none">
                                    ...
                                    <textarea id="input_post_schema_markup" name="schema_markup"
                                        ...
                                        rows="7">{{ old('schema_markup') }}</textarea>
                                    @error('schema_markup')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
