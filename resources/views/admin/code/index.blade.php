        ...
        <div class="card-header">
            <div class="boxHeader">
                ...
                <form class="row" method="GET">
                    <div class="col-8">
                        <a href="{{ route('code.create') }}" class="btn btn-primary _btn" role="button">
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="heightHr">Head <span class="dividerHr"></span></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 15%; vertical-align: middle">{{ $c->head }}</td>
                        <td style="width: 70%; vertical-align: middle">{{ $c->code_name }}</td>

                        <td style="width: 10%;" class="center-text boxAction fontField">
                            <div class="boxInside">

                                <div class="boxEdit" style="padding-top: 4px">
                                    <a href="{{ route('code.edit', ['code' => $c]) }}" class="btn-sm btn-info"
                                        role="button">
                                ...
                                <div class="boxDelete">
                                    <form action="{{ route('code.destroy', ['code' => $c]) }}" method="POST"
                                        role="alert">
                                        @csrf
                                        @method('DELETE')
