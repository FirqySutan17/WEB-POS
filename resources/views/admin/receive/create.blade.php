                            ...
                            <div class="col-12">
                                ...
                                <div class="row req-box">
                                    ...
                                    <div class="col-6" style="float: right; text-align: right">
                                        <input id="input-scanner" type="text" class="form-control input-scanner @error('suratjalan_number') is-invalid @enderror" placeholder="Input surat jalan number here"/>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group _form-group">
                            ...
                            <select id="select_item_product_${item_id}" data-itemid="${item_id}" name="skill[]"
