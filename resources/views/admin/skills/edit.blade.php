...
@endslot
{{ Breadcrumbs::render('detail_skill', $skill) }}
@endcomponent
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_title" value="{{ old('name', $skill->name) }}"
                                                name="name" type="text"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_slug" value="{{ old('slug', $skill->slug) }}"
                                                name="slug" type="text"
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input name="image" type="file" value="{{ old('image', $skill->image) }}"
                                                class="form-control" />
                                            <?php if (!empty($skill->image)): ?>
                                            <br>
                                            <a href="{{ asset('file_upload/'.$skill->image) }}" target="_blank"
                                            ...
                                            <div class="media-body text-end icon-state">
                                                <label class="switch">
                                                    <input type="checkbox" name="is_active" {{ old("is_active",
                                                        $skill->is_active) == 1 ? "checked" : null }}><span
