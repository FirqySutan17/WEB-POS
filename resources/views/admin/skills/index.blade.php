		...
		<div class="card-header">
			<div class="boxHeader">
				...
				<form class="row" method="GET">
					<div class="col-8">
						@can('Skill Create')
						<a href="{{ route('skill.create') }}" class="btn btn-primary _btn" role="button">
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td style="width: 85%; vertical-align: middle">{{ $s->name }}</td>

						<td style="width: 10%;" class="center-text boxAction fontField">
							<div class="boxInside">
								@can('Skill Update')
								<div class="boxEdit">
									<a href="{{ route('skill.edit', ['skill' => $s]) }}" class="btn-sm btn-info"
										role="button">
								...
								@can('Skill Delete')
								<div class="boxDelete">
									<form action="{{ route('skill.destroy', ['skill' => $s]) }}" method="POST"
										role="alert">
										@csrf
										@method('DELETE')
