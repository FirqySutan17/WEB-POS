...
@endslot
{{ Breadcrumbs::render('detail_project_type', $projectType) }}
@endcomponent

<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <form action="{{ route('project-type.update', ['project_type' => $projectType]) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_title" value="{{ old('name', $projectType->name) }}"
                                                name="name" type="text"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group _form-group">
                                            ...
                                            <input id="input_post_slug" value="{{ old('slug', $projectType->slug) }}"
                                                name="slug" type="text"
                                            ...
                                            <div class="media-body text-end icon-state">
                                                <label class="switch">
                                                    <input type="checkbox" name="is_active" {{ old("is_active",
                                                        $projectType->is_active) == 1 ? "checked" : null }}><span
