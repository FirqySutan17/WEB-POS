            ...
            <div class="boxHeader">
                ...
                <form class="row" method="GET">
                    <div class="col-8">
                        ...
                        <a href="{{ route('membership.create') }}" class="btn btn-primary _btn" role="button">
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="heightHr center-text">Phone & Email <span class="dividerHr"></span></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 20%; vertical-align: middle">#{{ $membership->code }}</td>
                        <td style="width: 40%; vertical-align: middle">{{ $membership->name }}</td>
                        <td style="width: 25%; vertical-align: middle" class="center-text">
                            {{ $membership->phone }} <br> {{ $membership->email }}
                        </td>
                        <td style="width: 10%;" class="center-text boxAction fontField">
                            <div class="boxInside">

                                <div class="boxEdit">
                                    <a href="{{ route('membership.edit', ['membership' => $membership]) }}"
                                ...
                                <div class="boxDelete">
                                    <form action="{{ route('membership.destroy', ['membership' => $membership]) }}"
        ...
        <div class="card-footer">
            <div class="boxFooter">
                ...
                <div class="boxPagination">
                    {{ $memberships->links('vendor.pagination.bootstrap-4') }}
                </div>
                @endif
            </div>
        </div>
