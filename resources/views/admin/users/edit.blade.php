					...
					<div class="card-body _card-body">
						<div class="row d-flex align-items-stretch">
							...
							<div class="col-12">
								...
								<div class="row">
									<div class="col-6">
										...
										<div class="form-group _form-group">
											...
											<input id="input_user_email" value="{{ old('email', $user->email) }}"
										...
										<div class="form-group _form-group">
											...
											<select id="select_user_office" name="office"
												data-placeholder="Choose Office"
												class="js-example-placeholder-multiple">
												<option value="Choose Office" {{ $user->office == 'Choose Office' ?
													'selected':'' }}>Choose Office</option>
												<option value="Rimba House, Cipondoh" {{ $user->office == 'Rimba House,
													Cipondoh' ? 'selected':'' }}>Rimba House, Cipondoh</option>
												<option value="Rimba House, Jakarta" {{ $user->office == 'Rimba House,
													Jakarta' ? 'selected':'' }}>Rimba House, Jakarta</option>
											</select>
											@error('role')
											<span class="invalid-feedback">
												{{ $message }}
									...
									<div class="col-6">
										...
										<div class="form-group _form-group">
											...
											<input id="input_user_name" value="{{ old('name', $user->name) }}"
												name="name" type="text"
								...
								<!-- status -->
								<div class="form-group {{ $errors->has('status') ? ' has-error' : '' }} _form-group"
									style="display: flex;">
									...
									<div class="col-2">
										<div class="media">
											<div class="media-body text-end icon-state">
												<label class="switch">
													<input type="checkbox" name="status" {{ old("status", $user->status)
													== 1 ? "checked" : null }}><span class="switch-state"></span>
												</label>
											</div>
										</div>
									</div>
