    ...
    <div class="card">
        <div class="card-header">
            <div class="boxHeader">
                ...
                <form class="row" method="GET">
                    <div class="col-8">
                        @can('PC Create')
                        <a href="{{ route('product-category.create') }}" class="btn btn-primary _btn" role="button">
        ...
        <div class="card-body table-responsive">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    @if (count($categories))
                    @forelse ($categories as $s)
                    <tr>
                        <td style="width: 5%;" class="center-text">{{ $loop->iteration }}</td>
                        <td style="width: 85%; vertical-align: middle">{{ $s->categories }}</td>
                        ...
                        <td style="width: 10%;" class="center-text boxAction fontField">
                            <div class="boxInside">
                                ...
                                <div class="boxEdit">
                                    {{-- {{ dd($s) }} --}}
                                    <a href="{{ route('product-category.edit', ['product_category' => $s]) }}"
                                ...
                                @can('PC Delete')
                                <div class="boxDelete">
                                    <form action="{{ route('product-category.destroy', ['product_category' => $s]) }}"
