    ...
    n.extend(h.prototype, {
        ...
        n.each(i, function (t, i) {
          ...
          n.isPlainObject(i)
            ...
            "function" === n.type(e.opts.caption) &&
              (l.opts.caption = e.opts.caption.apply(i, [e, l])),
            !l.opts.caption instanceof jQuery &&
              (l.opts.caption =
      ...
      updateControls: function (t) {
        ...
        o.$slide.trigger("refresh"),
          ...
          n("[data-fancybox-prev]").prop("disabled", !o.opts.loop && i <= 0),
          n("[data-fancybox-next]").prop(
            "disabled",
            !o.opts.loop && i >= e.group.length - 1
          ),
          "image" === o.type
            ? n("[data-fancybox-download]").attr(
                "href",
                o.opts.image.src || o.src
              )
            : n("[data-fancybox-download]").hide();
      },
      ...
      e(t).on("click", "[data-fancybox-share]", function () {
        ...
        t &&
          e.fancybox.open({
            src: t.translate(
              t,
              t.current.opts.share.tpl
                .replace(/\{\{src\}\}/g, encodeURI(t.current.src))
                .replace(
                  /\{\{descr\}\}/g,
                  encodeURI(t.current.opts.caption || "")
                )
            ),
            type: "html",
